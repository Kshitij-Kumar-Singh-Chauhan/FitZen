...
//-----------------------------------------------------------------------------
      ...
      if(Math.round((new Date().getTime() -t)/1000)>=max_time){ 
        ...
        message.text = "You have performed Virbhadrasan for " + max_time + " seconds";
  ...
  return (
    <div>
      ...
      <div style={styles.info}>
        <p style={{ color: '#b3a69f'}}>
          Try to mimic and hold the following pose.
        </p>
        <img src={yoga1} alternate="Yoga 1" style={{height:400, marginTop:50}}></img>
      </div>
